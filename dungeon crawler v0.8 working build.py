...
roomlist = ["trap","encounter","encounter","encounter","chest","chest","mimic","empty","empty","blocked","blocked"]
...
mimic_teeth = Weapon ("teet",10,["chomps","bites","gnaws on"])
...
#player setup--------------------------------------------------------------------------------------
player = Entity("steven the brave",male,100,100,0,0,shortsword.wpnatk,shortsword,0,0,[])
validating = True
while validating:
